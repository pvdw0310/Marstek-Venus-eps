...
> 🚀 Direct starten: open https://pvdw0310.github.io/Marstek-Venus-eps/ in Chrome of Edge
...
2. Tik op **"Verbind met batterij"** en kies je Venus (naam begint met `MST)
...
2. Tap **"Verbind met batterij"** (Connect) and pick your Venus (name starts with `MST)
