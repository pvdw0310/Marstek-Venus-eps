...
- 🌐 **NL/EN taalschakelaar** — onthoudt je keuze en volgt standaard de taal van je telefoon
...
2. Tik op **"Verbind met batterij"** en kies je Venus (naam begint met `MST_`)
...
- 🌐 **NL/EN language switch** — remembers your choice and defaults to your phone's language
...
2. Tap **"Connect to battery"** and pick your Venus (name starts with `MST_`)
